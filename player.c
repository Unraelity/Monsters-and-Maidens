    ...
    while (yesOrNo == 'y') {
        ...
        while (fscanf(inp, "%s", nameFile) != EOF) {
            if (strcmp(targetName, nameFile) == 0) {
                ...
                fscanf(inp, " %d %d %d %d %f %f %f %f %f %f %f %d %d %d %d %d %d %d", &player->maxHP, &player->hp, &player->maxMP, &player->mp, &player->magic[HEAL][1], &player->magic[FIRE][1], &player->magic[SHIELD][1], &player->magicDefense, &player->attack, &player->defense, &player->speed, &player->gold, &player->maxEXP, &player->exp, &player->level, &eventNum, &player->numWins, &player->numLosses);
            }
        }
...
void saveCharacter(party player, int eventNum) {
    ...
    fprintf(outp, "%s %d %d %d %d %f %f %f %f %f %f %f %d %d %d %d %d %d %d", player.name, player.maxHP, player.hp, player.maxMP, player.mp, player.magic[HEAL][1], player.magic[FIRE][1], player.magic[SHIELD][1], player.magicDefense, player.attack, player.defense, player.speed, player.gold, player.maxEXP, player.exp, player.level, eventNum, player.numWins, player.numLosses);
